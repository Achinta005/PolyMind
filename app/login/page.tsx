  ...
  return (
    <div className="min-h-screen bg-[#050810] flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden flex-col justify-between p-12">
        ...
        <div className="absolute top-1/4 left-1/4 w-64 h-64 bg-[#c8f04d]/8 rounded-full blur-[80px]" />
        ...
        <div className="relative z-10">
          <blockquote className="text-3xl font-black leading-tight mb-4">
            "Your documents.<br />
            <span className="text-[#c8f04d]">Your questions.</span><br />
            Real answers."
          </blockquote>
          <p className="text-white/40 text-sm">
            Upload. Search. Discover. — all in one place.
          </p>
        </div>

        <div className="relative z-10 pm-card p-4 max-w-xs">
          <div className="flex items-center gap-3 mb-3">
            <div className="w-8 h-8 bg-[#c8f04d]/10 rounded-lg flex items-center justify-center">
              <span className="text-[#c8f04d] text-xs font-mono">PDF</span>
            </div>
            <div>
              <p className="text-sm font-semibold">research_paper.pdf</p>
              <p className="text-white/30 text-xs font-mono">47 pages · 2.1 MB</p>
            </div>
          </div>
          <div className="bg-[#c8f04d]/5 border border-[#c8f04d]/15 rounded-lg p-3">
            <p className="text-white/60 text-xs leading-relaxed">
              <span className="text-[#c8f04d]">Q: </span>What methodology was used in the study?
            </p>
            <p className="text-white/80 text-xs mt-1 leading-relaxed">
              The authors employed a mixed-methods approach...{" "}
              <span className="text-[#c8f04d] underline cursor-pointer">p.12</span>
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-md animate-float-up">
          ...
          <p className="text-white/40 text-sm mb-8">Sign in to continue your research</p>
            ...
            <div>
              <div className="flex items-center justify-between mb-1.5">
                ...
                <Link
                  ...
                  className="text-xs text-white/30 hover:text-[#c8f04d] transition-colors"
                >
                  Forgot password?
                </Link>
              </div>
          ...
          <p className="text-center text-white/30 text-sm mt-6">
            No account?{" "}
            <Link href="/register"
              className="text-[#c8f04d] hover:text-[#d4f86e] transition-colors font-semibold">
              Create one free
            </Link>
          </p>
        </div>
